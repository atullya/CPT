...
const pipelineStages = [
  {
    ...
    icon: (() => (
      <div className="w-4 h-4 border-2 border-dashed border-zinc-500 rounded-full"></div>
    ))(),
  },
  {
    stage: "Technical",
    ...
    icon: (
      <img
        src={technicalIcon || "/placeholder.svg"}
        alt="Technical"
        className="w-4 h-4"
      />
    ),
  },
  {
    ...
    icon: (
      <img
        src={additionalIcon || "/placeholder.svg"}
        alt="Additional"
        className="w-4 h-4"
      />
    ),
  },
  {
    ...
    icon: (
      <img
        src={clientIcon || "/placeholder.svg"}
        alt="Client"
        className="w-4 h-4"
      />
    ),
                ...
                <KanbanColumn
                  ...
                  header={
                    <div className="w-full h-[42px] p-2 flex items-center gap-2">
                      <div
                        className={`w-[114px] h-[26px] rounded-md px-2 py-1 ${config.headerBg} flex items-center gap-2`}
                      >
                        {config.icon}
                        <span
                          className={`w-[65px] h-[18px] flex items-center justify-start font-plusJakarta font-semibold text-[12px] leading-[18px] ${config.textColor}`}
                        >
                          {config.stage}
                        </span>
